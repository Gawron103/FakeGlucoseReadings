...
import com.example.glucosereadings.viewmodels.AddDexcomG6CgmViewModel
import com.example.glucosereadings.viewmodels.AddDexcomG6CgmViewModelFactory
...
class AddDexcomG6CgmFragment : Fragment() {
    ...
    private val viewModel by viewModels<AddDexcomG6CgmViewModel> {
        AddDexcomG6CgmViewModelFactory(SensorRepository.getInstance())
    }
